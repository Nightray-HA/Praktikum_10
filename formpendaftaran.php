         ...
         <div class="col-md-6">
           <div class="card">
             ...
             <div class="card-body">
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     <select name="transportasi" class="form-control">
                       ...
                       <option value="Perahu/Rakit">Perahu Penyebrangan/Rakit</option>
                       <option value="Lainnya">Lainnya</option>
               ...
               <a href="reportpdf.php"><button class = "btn btn-primary">Simpan PDF</button></a><!--tombol untuk menyimpan pdf-->
             </div>
           </div>
         </div>
       </div>
